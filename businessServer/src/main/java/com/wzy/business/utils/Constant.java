package com.wzy.business.utils;

public class Constant {

    //************** FOR MONGODB ****************

    public static String MONGODB_DATABASE = "wzyrecommender";
    ...
    public static String MONGODB_AVERAGE_PRODUCTS_SCORE_COLLECTION = "AverageProductsScore";
